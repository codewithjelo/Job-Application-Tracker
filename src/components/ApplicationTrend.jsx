  ...
  return (
    <div className="rounded-md p-3 border border-[var(--border)] h-full">
      <div className="flex items-center justify-between mb-4">
        <p className="text-sm md:text-md text-[var(--primary)] font-semibold flex items-center gap-2">
      ...
      <ResponsiveContainer className="md:hidden" width="100%" height={200}>
      ...
      <ResponsiveContainer className="hidden md:flex" width="100%" height={300}>
        <LineChart data={trendData}>
          <CartesianGrid strokeDasharray="3 3" />
          <XAxis
            dataKey="period"
